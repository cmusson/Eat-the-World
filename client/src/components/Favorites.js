...
export default function CountryPage ({ favorites, SetFavorites, SetSelectedDish, countrySelected, updateFavorites }) {
...
return(
    <div className="country-page-container">
            ...
            <h2>The Best of the Best!</h2>
                ...
                {favorites.map(fav => {
                    return <div className="link" key={fav}>
                            ...
                            <div className="favorites-selector" onClick={() => {updateFavorites(fav);
                            }}>
